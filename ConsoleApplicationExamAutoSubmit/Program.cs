...
namespace ConsoleApplicationExamAutoSubmit
{
    class Program
    {
        private static string urlGet = "http://wechat.sctcn.com/SctWeChat_Exam/WX/GetExamList?ExamTypeNo&Pname=赵子清&Pno=SCT01976&Pdepart=信息技术部&Type=WX";
        ...
        static void Main(string[] args)
        {
            ...
            if(!resGet.StartsWith("["))
            {
                Console.WriteLine("试题获取错误！");
                Console.ReadKey();
                return;
            }
